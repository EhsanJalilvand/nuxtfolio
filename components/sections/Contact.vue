          ...
          <form @submit.prevent="submitForm" class="space-y-6">
            <div>
              ...
              <input
                ...
                v-model="form.name"
                type="text"
                class="w-full px-4 py-2 rounded-lg border focus:ring-primary focus:border-primary"
                required
              >
            </div>
        ...
        <div class="space-y-6">
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <a href="mailto:contact@example.com" class="text-gray-600 dark:text-gray-300">contact@example.com</a>
            </div>
          </div>
          ...
          <div class="flex items-start gap-4">
            <Icon name="mdi:map-marker" class="w-6 h-6 mt-1 text-primary" />
            <div>
              <h3 class="text-lg font-semibold">{{ $t('contact.info.location') }}</h3>
              <p class="text-gray-600 dark:text-gray-300">Tehran, Iran</p>
            </div>
          </div>
        </div>
      </div>
